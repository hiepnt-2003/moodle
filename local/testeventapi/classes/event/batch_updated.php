...
/**
 * Event fired when a batch is updated.
 *
 * @package    local_testeventapi
 * @copyright  2025 Your Name <your.email@example.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class batch_updated extends \core\event\base {
    ...
    public function get_description() {
        return "Đợt học '{$this->other['name']}' đã được cập nhật (ID: {$this->objectid}).";
    }
    ...
    public function get_url() {
        return new \moodle_url('/local/testeventapi/view.php', ['id' => $this->objectid]);
    }
