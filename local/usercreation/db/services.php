...
$functions = [
    'local_usercreation_create_user' => [
        'classname'   => 'local_usercreation_external',
        'methodname'  => 'create_user',
        'classpath'   => 'local/usercreation/externallib.php',
...
$services = [
    'User Creation Service' => [
        'functions' => ['local_usercreation_create_user'],
        'restrictedusers' => 0,
        'enabled' => 1,
        'shortname' => 'user_creation_service',
        'downloadfiles' => 0,
        'uploadfiles' => 0,
    ],
];